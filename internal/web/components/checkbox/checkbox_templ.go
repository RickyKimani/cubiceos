...
// templui component checkbox - version: v0.97.0 installed by templui v0.97.0
...
import (
	"github.com/rickykimani/cubiceos/internal/web/components/icon"
...
func Checkbox(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/checkbox/checkbox.templ`, Line: 33, Col: 13}
			}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/checkbox/checkbox.templ`, Line: 36, Col: 17}
			}
		...
		if p.Value != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/checkbox/checkbox.templ`, Line: 39, Col: 19}
			}
		...
		if p.Form != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/checkbox/checkbox.templ`, Line: 44, Col: 17}
			}
